...
#include "MyProject_1/OpenDoor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	MYPROJECT_1_API UClass* Z_Construct_UClass_UOpenDoor_NoRegister();
	MYPROJECT_1_API UClass* Z_Construct_UClass_UOpenDoor();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOpenDoor_Statics::NewProp_OpenAngle_MetaData[] = {
		{ "Category", "OpenDoor" },
		{ "Comment", "//(Macros) Add to view parameter in Unreal Engine\n" },
		{ "ModuleRelativePath", "OpenDoor.h" },
		{ "ToolTip", "(Macros) Add to view parameter in Unreal Engine" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOpenDoor_Statics::NewProp_OpenAngle = { "OpenAngle", nullptr, (EPropertyFlags)0x0040000000020001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOpenDoor, OpenAngle), METADATA_PARAMS(Z_Construct_UClass_UOpenDoor_Statics::NewProp_OpenAngle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOpenDoor_Statics::NewProp_OpenAngle_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UOpenDoor, 3829100665);
	template<> MYPROJECT_1_API UClass* StaticClass<UOpenDoor>()
	{
		return UOpenDoor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UOpenDoor(Z_Construct_UClass_UOpenDoor, &UOpenDoor::StaticClass, TEXT("/Script/MyProject_1"), TEXT("UOpenDoor"), false, nullptr, nullptr, nullptr);
